...
export default function InquiryForm() {
  ...
  const S = {
    ...
    logoIcon: { width:"40px", height:"40px", background:"#2f81f7", borderRadius:"10px", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"18px", boxShadow:"0 0 20px rgba(47,129,247,0.4)" },
    logoText: { fontFamily:"'Syne', sans-serif", fontSize:"20px", fontWeight:800, color:"#e6edf3" },
    h1: { fontFamily:"'Syne', sans-serif", fontSize:"32px", fontWeight:800, letterSpacing:"-0.5px", lineHeight:1.2, marginBottom:"10px" },
    subtitle: { color:"#8b949e", fontSize:"15px", lineHeight:1.6 },
    ...
    input: { background:"#161b22", border:"1px solid #21262d", borderRadius:"8px", color:"#e6edf3", fontFamily:"'DM Sans', sans-serif", fontSize:"14px", padding:"11px 14px", outline:"none", width:"100%", boxSizing:"border-box" },
    section: { marginTop:"20px" },
    sectionTitle: { fontSize:"13px", fontWeight:600, color:"#8b949e", textTransform:"uppercase", letterSpacing:"0.08em", marginBottom:"12px" },
    ...
    camBtn: { padding:"9px 16px", borderRadius:"8px", border:"1px solid #30363d", background:"#161b22", color:"#e6edf3", cursor:"pointer", fontSize:"13px", fontWeight:500 },
    camBtnPrimary: { padding:"9px 16px", borderRadius:"8px", border:"none", background:"#2f81f7", color:"#fff", cursor:"pointer", fontSize:"13px", fontWeight:600 },
    camBtnDanger: { padding:"9px 16px", borderRadius:"8px", border:"none", background:"rgba(248,81,73,0.15)", color:"#f85149", cursor:"pointer", fontSize:"13px", fontWeight:500 },
    ...
    pill: { padding:"8px 16px", borderRadius:"99px", border:"1px solid #21262d", background:"#161b22", color:"#8b949e", cursor:"pointer", fontSize:"13px", fontWeight:500 },
    pillActive: { border:"1px solid #2f81f7", background:"rgba(47,129,247,0.1)", color:"#2f81f7" },
    submitBtn: { width:"100%", padding:"14px", background:"#2f81f7", color:"#fff", border:"none", borderRadius:"10px", fontSize:"15px", fontWeight:700, cursor:"pointer", marginTop:"24px", fontFamily:"'Syne', sans-serif", letterSpacing:"0.05em" },
    alert: (type) => ({ padding:"14px 18px", borderRadius:"10px", fontSize:"14px", marginBottom:"16px", background: type === "success" ? "rgba(63,185,80,0.1)" : "rgba(248,81,73,0.1)", border:`1px solid ${type === "success" ? "rgba(63,185,80,0.3)" : "rgba(248,81,73,0.3)"}`, color: type === "success" ? "#3fb950" : "#f85149" }),
          ...
          <div style={S.card}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={S.photoSection}>
                <div style={{ ...S.photoWrap, border: photoPreview ? "2px solid #3fb950" : "2px solid #30363d" }}>
                  {photoPreview
                    ...
                    : <span style={{ color:"#484f58", fontSize:"40px" }}>👤</span>
                  }
                </div>
                ...
                <p style={{ fontSize:"12px", color: photoPreview ? "#3fb950" : "#f0883e" }}>{photoStatus}</p>
              </div>
              ...
              >
                ...
                <div>
                  <div style={{ fontWeight:600, fontSize:"14px" }}>Not Sure Yet</div>
                  <div style={{ color:"#8b949e", fontSize:"12px" }}>I'll decide after visiting</div>
                </div>
              </div>
              {plans.map(plan => (
                <div key={plan.id}
                ...
                >
                  ...
                  <div style={{ flex:1 }}>
                    ...
                    <div style={{ color:"#8b949e", fontSize:"12px" }}>{durationLabel(plan.duration_type, plan.duration_days)}</div>
                  </div>
                  <div style={{ fontWeight:700, color:"#2f81f7", fontSize:"15px" }}>₹{Number(plan.price).toLocaleString("en-IN")}</div>
                </div>
              ))}
