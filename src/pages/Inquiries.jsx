    ...
    <div style={{ display:"flex", minHeight:"100vh", background:"var(--bg-base)", fontFamily:"var(--font-body)" }}>
      ...
      <main style={{ flex:1, padding:"20px 16px", overflowY:"auto" }}>
        ...
        <div className="fade-up" style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:"20px", flexWrap:"wrap", gap:"12px" }}>
          <div>
            <h1 style={{ fontFamily:"var(--font-display)", fontSize:"22px", fontWeight:800, color:"var(--text-primary)", letterSpacing:"-0.5px", margin:0 }}>Inquiries</h1>
            <p style={{ color:"var(--text-muted)", fontSize:"12px", marginTop:"3px" }}>
              ...
              <thead>
                <tr style={{ background:"var(--bg-elevated)" }}>
                  {["#","Person","Interest","Preferred Time","Received","Status",""].map((h,i) => (
                    <th key={i} className={["Preferred Time","Received"].includes(h) ? "inq-hide-mobile" : ""} style={{ padding:"10px 16px", textAlign:h===""?"center":"left", fontSize:"11px", fontWeight:600, color:"var(--text-muted)", textTransform:"uppercase", letterSpacing:"0.08em", borderBottom:"1px solid var(--border-subtle)", whiteSpace:"nowrap" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {loading ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="inq-hide-mobile" style={{ padding:"13px 16px", color:"var(--text-secondary)", fontSize:"13px" }}>
                        {TIME_MAP[inq.preferred_time] || "Anytime"}
                      </td>
                      <td className="inq-hide-mobile" style={{ padding:"13px 16px", color:"var(--text-secondary)", fontSize:"12px", whiteSpace:"nowrap" }}>
